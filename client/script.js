...
// const api = 'a96213b62d6ce0665e26d7ae7532016e'
// const url = `https://api.themoviedb.org/3/tv/popular?api_key=${api}&language=en-US&page=1`
// let baseUrl = ''
// $(document).ready(() => {
//   $.get(`https://api.themoviedb.org/3/configuration?api_key=${api}`, (data) => {
...
$(document).ready(() => {
  $.get('localhost:3000/api/trending', (data) => {
    console.log(data)
  })
})
